...
class ordemDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'ordems.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\ordem $model
